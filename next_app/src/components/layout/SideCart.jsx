                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-6">
                            {cartItems.length === 0 ? (
                                ...
                                cartItems.map(item => (
                                    ...
                                    >
                                        <div className="w-20 h-20 bg-white rounded-lg overflow-hidden flex-shrink-0 border border-gray-100 relative">
                                            {/* Using standard img for external URLs if not configured */}
