...
const About = () => {
    return (
        <div className="bg-royal-cream min-h-screen pt-20">
            {/* HER SECTOIN */}
            <div className="relative h-[60vh] bg-royal-dark overflow-hidden flex items-center justify-center" style={{ paddingTop: '30px' }}>
