    ...
    return (
        <div className="p-8">
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="font-serif text-3xl font-bold text-royal-dark">Customer Reviews</h1>
                    <p className="text-gray-500">Manage what people are saying about your brand.</p>
                </div>
