...
export default function AdminDashboard() {
    ...
    return (
        <div>
            {/* Title Section (Handled in Layout roughly, but we can add specific here if needed) */}
            <div className="mb-6">
                <h2 className="text-lg text-gray-600">Here is what’s happening with your store today.</h2>
            </div>
