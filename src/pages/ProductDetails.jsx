    ...
    if (!product) {
        return (
            <div className="pt-32 text-center min-h-screen">
                ...
                <Link to="/shop" className="text-royal-gold hover:underline mt-4 inline-block">Back to Shop</Link>
            </div>
        );
    }
    ...
    return (
        <div className="pt-32 pb-20 min-h-screen bg-royal-cream">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <Link to="/shop" className="inline-flex items-center text-gray-500 hover:text-royal-green mb-8 transition-colors">
