        ...
        <div className="bg-royal-cream">
            ...
            <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mt-12">
                    <Link to="/shop" className="inline-flex items-center text-royal-dark font-medium hover:text-royal-gold transition-colors border-b-2 border-transparent hover:border-royal-gold pb-1">
