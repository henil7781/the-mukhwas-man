                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="flex space-x-4 pt-4">
                            <Link to="/shop" className="bg-royal-gold hover:bg-yellow-600 text-white px-8 py-4 rounded-full font-medium transition-all transform hover:scale-105 flex items-center shadow-lg hover:shadow-royal-gold/20">
                                Shop Collection <ArrowRight className="ml-2 w-5 h-5" />
                            </Link>
                            <Link to="/about" className="px-8 py-4 rounded-full border border-royal-cream/20 text-royal-cream hover:bg-royal-cream/10 transition-all font-medium">
                                Our Story
                            </Link>
                        </div>
                    </motion.div>
