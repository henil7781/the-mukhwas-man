                ...
                <div className="flex justify-between items-center h-20">
                    ...
                    {!isSearchOpen && (
                        <div className="hidden md:flex space-x-8 items-center">
                            <Link to="/" className="text-royal-dark hover:text-royal-gold transition-colors font-medium">Home</Link>
                            <Link to="/shop" className="text-royal-dark hover:text-royal-gold transition-colors font-medium">Shop</Link>
                            <Link to="/about" className="text-royal-dark hover:text-royal-gold transition-colors font-medium">Our Story</Link>
                        </div>
                    )}
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        <Link to={user ? "/profile" : "/login"} className="text-royal-dark hover:text-royal-gold transition-colors">
                            {user ? (
                                <div className="w-6 h-6 rounded-full overflow-hidden border border-royal-dark">
                ...
                {isOpen && (
                    ...
                    >
                        <div className="px-4 pt-2 pb-6 space-y-2">
                            <Link to="/" className="block px-3 py-2 text-royal-dark font-medium" onClick={() => setIsOpen(false)}>Home</Link>
                            <Link to="/shop" className="block px-3 py-2 text-royal-dark font-medium" onClick={() => setIsOpen(false)}>Shop</Link>
                            <Link to="/about" className="block px-3 py-2 text-royal-dark font-medium" onClick={() => setIsOpen(false)}>Our Story</Link>
                            <Link to={user ? "/profile" : "/login"} className="block px-3 py-2 text-royal-dark font-medium" onClick={() => setIsOpen(false)}>
